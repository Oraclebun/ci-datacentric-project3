...
location_ids = Location.objects.bulk_create([
    Location('Ireland', province = [Province(state='Leinster', town = Town(town='Carlow'))]),
    Location('Ireland', province = [Province(state='Leinster', town = Town(town='Dublin'))]),
    Location('Ireland', province = [Province(state='Leinster', town = Town(town='Kilkenny'))]),
    Location('Ireland', province = [Province(state='Leinster', town = Town(town='Wicklow'))]),  
    Location('Ireland', province = [Province(state='Munster', town = Town(town='Cork'))]),          
    Location('Ireland', province = [Province(state='Munster', town = Town(town='Killarney'))]),     #5
    ...
    Location('Japan', province = [Province(state='Okinawa', town = Town(town='Kunigami'))]),   
    Location('Japan', province = [Province(state='Kansai', town = Town(town='Kyoto'))]),            
    Location('Japan', province = [Province(state='Kansai', town = Town(town='Osaka'))]),            #10
    Location('Japan', province = [Province(state='Kanto', town = Town(town='Tokyo'))]),
    Location('Japan', province = [Province(state='Kanto', town = Town(town='Nikko'))]),
    Location('New Zealand', province = [Province(state='North Island', town = Town(town='Auckland'))]), 
    Location('New Zealand', province = [Province(state='North Island', town = Town(town='Bay of Plenty'))]), 
    Location('New Zealand', province = [Province(state='North Island', town = Town(town="Hawke's Bay"))]),          #15
    Location('New Zealand', province = [Province(state='North Island', town = Town(town='Gisborne'))]),
    Location('New Zealand', province = [Province(state='North Island', town = Town(town='Taranaki'))]),
    Location('New Zealand', province = [Province(state='North Island', town = Town(town='Waikato'))]),      
    Location('New Zealand', province = [Province(state='North Island', town = Town(town='Whanganui-Manawatu'))]), 
    Location('New Zealand', province = [Province(state='North Island', town = Town(town='Wellington'))]),           #20
    Location('New Zealand', province = [Province(state='South Island', town = Town(town='Canterbury'))]),
    Location('New Zealand', province = [Province(state='South Island', town = Town(town='Marlborough'))]),
    Location('New Zealand', province = [Province(state='South Island', town = Town(town='Nelson-Tasman'))]),        
    Location('New Zealand', province = [Province(state='South Island', town = Town(town='Otago'))]),        
    Location('New Zealand', province = [Province(state='South Island', town = Town(town='Southland'))]),            #25
    Location('New Zealand', province = [Province(state='South Island', town = Town(town='West Coast'))]),
    Location('Singapore', province = [Province(state='Central', town = Town(town='Bukit Merah'))]),
    Location('Singapore', province = [Province(state='Central', town = Town(town='Kallang'))]),                     
    Location('Singapore', province = [Province(state='East', town = Town(town='Pasir Ris'))]),
    Location('Singapore', province = [Province(state='East', town = Town(town='Tampines'))]),                       #30
    Location('Singapore', province = [Province(state='North', town = Town(town='Woodlands'))]),         
    Location('Singapore', province = [Province(state='North', town = Town(town='Yishun'))]),
    Location('Singapore', province = [Province(state='North East', town = Town(town='Punggol'))])                   #32
])
...
trail_ids = Trails.objects.bulk_create([
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[-8.618198,52.666321],[-8.610047,52.681250],[-9.508434,52.008956]]},
...
Trails(
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[135.639560, 34.730457],[135.646922, 34.734703],[135.656984, 34.730551],[135.666802, 34.728892]]},
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[139.621977, 36.747450],[139.612354, 36.751948],[139.604101, 36.753609],[139.594343, 36.750556], [139.581471, 36.747618]]},
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[128.177421, 26.720088],[128.182525, 26.717853],[128.183317, 26.714794],[128.186713, 26.710001]]},
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[170.093309, -43.718564],[170.100145, -43.705616],[170.098250,-43.692727],[170.103642, -43.689006]]},
    embed_route = '<iframe src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d23868.6001931881!2d170.09152413636355!3d-43.705885529820286!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e2!4m5!1s0x6d2a4b341d69d4dd%3A0x63bc845abb08c829!2sHooker%20Valley%20track!3m2!1d-43.718125699999995!2d170.0939684!4m5!1s0x6d2bb534cfa517b9%3A0xe1f9b2ca2f96b8a4!2sHooker%20Valley%20Track%2C%20Mount%20Cook%20National%20Park%207999%2C%20New%20Zealand!3m2!1d-43.6889987!2d170.1036532!5e0!3m2!1sen!2ssg!4v1594029536331!5m2!1sen!2ssg" width="400" height="400" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>',
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[170.095664, -43.732055],[170.093873, -43.731980],[170.084021, -43.710040]]},
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[174.810048, -36.863432],[174.816867, -36.868651],[174.817707, -36.869028],[174.818927, -36.866059],[174.810048, -36.863432]]},
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[174.786884, -36.896078],[174.787086, -36.901807],[174.780146, -36.904514],[174.783205, -36.899682],[174.778881, -36.900085],[174.781735, -36.897434], [174.786884, -36.896078]]},
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[168.661168, -45.033171],[168.662451, -45.034913],[168.657459, -45.039189],[168.661674, -45.038065],[168.674122, -45.035638]]},
...
Trails(
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[168.666625, -45.027502],[168.667612,-45.023824],[168.673502, -45.026743],[168.673180, -45.023483], [168.672353, -45.023736]]},
...
Trails(
    ...
    waypoints= {'type': 'LineString', 'coordinates': [[103.915651, 1.416899,],[103.929738, 1.401506],[103.928770, 1.405492],[103.923835, 1.410408], [103.921217, 1.412392], [103.915651, 1.416899,]]},
